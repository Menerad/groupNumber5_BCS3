  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Expanded(
                child: Container(
            color: Colors.pink, // Set the background color to dodgerblue
            child: ListView(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Middle Name: ${user.middleName}', style: TextStyle(fontSize: 18)),
                ...
                Text('Country of Birth: ${user.countryOfBirth}', style: TextStyle(fontSize: 18)),
              ],
            ),
          ),
        ),
